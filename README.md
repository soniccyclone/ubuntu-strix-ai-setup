...
tests/           32 bats suites, run with `make test`
...
**14 of the 32 need the GPU, the model weights and the services running**, and
...
The other eighteen check things that hold anywhere — licensing, documentation
...
The beads scaffolding is generated by [bd](https://github.com/steveyegge/beads)
and stays under its own MIT terms; [NOTICE](NOTICE) lists what that covers, and
what this repository references without distributing.
